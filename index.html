...
<header class="main_header">
  <div class="inner">
    <h1 class="logo"><a href="index.html"><img src="images/logo.png" alt="新築住宅、リフォーム、リノベーションのことなら愛知県名古屋市西区のウサミ建工にお任せください。" width="240" height="75" class="img-responsive"></a></h1>
    <div class="nav hidden-xs">
      <p><a href="https://www.instagram.com/usamigroup/" target="_blank" class="opacity"><img src="images/icon_insta.png" alt="Instagram" width="22" height="22" class="img-responsive"></a></p>
  ...
  <div class="inner">
    <nav class="main_nav">
      ...
      <div class="visible-xs-block text-center">
        <a href="https://www.instagram.com/usamigroup/" target="_blank" class="opacity"><img src="images/icon_insta.png" alt="Instagram" width="22" height="22" class="img-responsive"></a>
...
<div class="for_edge"><img src="images/main02b.jpg" alt=""></div>
<main>
  <section id="main01">
    <div class="container-fluid">
      ...
      <div class="row mb50 xs-mb30">
        <div class="col-xs-12 col-sm-4 xs-mb30">
          ...
          <p><img src="images/index_ph01.jpg" alt="地元・地域密着型" width="900" height="600"></p>
        </div>
        <div class="col-xs-12 col-sm-4 xs-mb30">
          ...
          <p><img src="images/index_ph02.jpg" alt="高い技術力" width="900" height="600"></p>
        </div>
        <div class="col-xs-12 col-sm-4">
          ...
          <p><img src="images/index_ph03.jpg" alt="無料相談" width="900" height="600"></p>
        </div>
      </div>
...
<!--                    <tr>
                      ...
                      <td class="cat">
                        <span style="background:#d9eeed;">イベント</span>
                      </td>
                      <td class="area">
                        <div class="txt">ホームページを作成致しました。今後とも宜しくお願い致します。</div>
                      </td>
                    </tr>
                     LOOP 
                ...
                <div class="tab-pane fade" id="cl03">
                  <table>
                    ...
                    <tr>
                      ...
                      <td class="cat">
                        <span style="background:#ebe1e0;">お知らせ</span>
                      </td>
                      <td class="area">
                        <div class="txt">ホームページを作成致しました。今後とも宜しくお願い致します。</div>
                      </td>
                ...
                <div class="tab-pane fade" id="cl04"> 初期表示のみ、 in active クラス必須 
                  <table>
                    ...
                    <tr>
                      ...
                      <td class="cat">
                        <span style="background:#eee3d9;">その他</span>
                      </td>
                      <td class="area">
                        <div class="txt">ホームページを作成致しました。今後とも宜しくお願い致します。</div>
                      </td>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-sm-push-4 col-md-6 col-md-push-6">
          ...
          <div class="inner">
            <h2 class="text-center mb20 xs-mb10"><img src="images/index_ttl04.png" alt="リフォーム・リノベーション" width="348" height="61" class="xs-w70"></h2>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xs-12 col-sm-8 col-md-6">
          ...
          <div class="inner">
            <h2 class="text-center mb20 xs-mb10"><img src="images/index_ttl05.png" alt="新築住宅" width="309" height="61" class="xs-w60"></h2>
  ...
  <div class="footer_inner">
    <div class="row row-nopadding">
      <div class="col-sm-12 col-sm-6">
        ...
        <p class="ad">〒452-0824 <br class="visible-xs-inline visible-sm-inline">愛知県名古屋市西区こも原町33番地</p>
        <div class="tel_box">
          <p class="tel"><span data-action="call" data-tel="052-325-7250">TEL 052-325-7250</span></p>
          <p class="fax">FAX 052-325-7303</p>
        </div>
        <div class="btns">
          <a href="https://www.instagram.com/usamigroup/" target="_blank"><img src="images/icon_insta.png" alt="Instagram" width="22" height="22" class="img-responsive"></a>
      ...
      <div class="col-sm-12 col-sm-6">
        ...
        <div class="img_map">
          <img src="images/bnrs.png" alt="" width="458" height="117" usemap="#Map" class="img-responsive">
          <map name="Map">
            <area shape="rect" coords="22,34,185,84" href="http://house-inspector.org/" target="_blank" alt="AJHIA">
            <area shape="rect" coords="188,34,301,86" href="https://www.reform-contact.com/" target="_blank" alt="Reform Contact">
            <area shape="rect" coords="311,32,371,87" href="https://www.jio-kensa.co.jp/" target="_blank" alt="JIO">
            <area shape="rect" coords="376,29,438,88" href="https://aichi.jyokatsu.jp/advance/authentication.html" target="_blank" alt="あいち女性輝きカンパニー">
          </map>
        </div>
      </div>
    </div>
